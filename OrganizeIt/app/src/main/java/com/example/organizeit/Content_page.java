...
//        files_Fetch(dateDetails,date);
        ...
        imageItems.add(new Item(R.drawable.baseline_image_24, "anujaa.pdf"));
                        pdfItems.add(new Item(R.drawable.baseline_picture_as_pdf_24, "nandini.jpg"));
                        pdfItems.add(new Item(R.drawable.baseline_picture_as_pdf_24, "nandini1.jpg"));
                        pdfItems.add(new Item(R.drawable.baseline_picture_as_pdf_24, "nandini2.jpg"));
